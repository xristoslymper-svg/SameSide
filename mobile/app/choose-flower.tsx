...
function FlowerSelection() {
 ...
 return <Screen><Brand/>{legacy && <Button label="Back to Garden" secondary disabled={busy} onPress={() => router.dismissTo('/garden')}/>}<LoadState {...state}/>
  ...
  : <><Text style={styles.eyebrow}>Choose what you’ll grow</Text><Text style={styles.title}>Every flower carries a story.</Text><Text style={styles.body}>Choose the one whose meaning feels like yours.</Text>
