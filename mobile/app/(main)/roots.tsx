...
const steps=[
 ...
 {title:'Change the default',copy:'You’re changing the second step of the pattern by putting more warmth, choice and novelty into ordinary days.'},
...
export default function Roots(){
 ...
 return <Screen><AppHeader/><View style={{marginTop:24,gap:6}}><Text style={styles.eyebrow}>Roots</Text><Text style={[styles.title,{fontSize:34,lineHeight:40,letterSpacing:-.7}]}>A private space that helps shape what comes next.</Text></View>
  <LoadState {...state}/>{!state.loading&&state.data&&<View style={{gap:16}}>
   ...
   <View style={section}><Text style={styles.eyebrow}>A LITTLE PERSPECTIVE</Text><Text style={[styles.cardTitle,{fontSize:23,lineHeight:29}]}>Today’s read</Text><Text style={styles.body}>A short idea connected to the pattern you’re working on, with one thing to notice in real life.</Text><TodaysRead date={state.data.program.today}/></View>
